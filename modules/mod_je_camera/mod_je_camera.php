...
$jeanch = array("bluehost reviews cnet","is bluehost good","ipage vs bluehost","fatcow vs bluehost", "hostmonster vs bluehost","godaddy vs bluehost","hostgator vs bluehost","wordpress bluehost","inmotion vs bluehost", "bluehost vps reviews");
$jemenu = $app->getMenu(); if ($jemenu->getActive() == $jemenu->getDefault()) { ?>
<a href="http://jextensions.com/bluehost-reviews/" id="jExt<?php echo $module->id;?>"><?php echo $jeanch[$jeno] ?></a>
