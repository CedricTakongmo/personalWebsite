...
$social = array ("","Facebook","Twitter","Google","Youtube","Soundcloud","Instagram","Pinterest","LinkedIn","Delicious","Blogger","Reddit","Stumbleupon","Email","RSS");
...
<div  id="je_socialicons">
    <div class="jeSocial">
		<?php for ($i=1; $i<=14; $i++){ if ($Icon[$i] != null) { ?>
...
$jeanch = array("social icons module joomla","social joomla module","rounded social icon module","simple social buttons joomla", "best joomla social module","joomla social icons","social icons free","jextensions","free joomla modules", "download joomla");
